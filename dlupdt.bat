...
:: Check krd version
.\Tools\curl -# -O "https://rescuedisk.s.kaspersky-labs.com/updatable/2018/bases/krd.xml" --ca-native > nul 2>&1
...
echo:
echo Renaming files!
if exist 042-freshbases.srm ren "042-freshbases.srm" "005-bases.srm"
if exist hashes.txt for /f "tokens=1" %%I in ('FINDSTR /L "042-freshbases.srm" "hashes.txt"') do echo %%I *005-bases.srm> 005-bases.srm.sha512
echo:
echo:
